...
helpMessage ="""sεℓғвσт вү-sρεcιαℓ αηιмε
====={List Keyword]=====
► Help
► Creator
► Gcreator
...
Creator="u30ef8888fc6633edaef95fe68c686c48"
admin=["u30ef8888fc6633edaef95fe68c686c48"]
...
#--------------------------------------------------------
		...
		try:
		    ...
		    cl.comment(url['result']['posts'][0]['userInfo']['mid'], url['result']['posts'][0]['postInfo']['postId'], "Auto Like By ѕρє¢ιαℓ αиιмє\nFollow line@at : https://line.me/R/ti/p/%40kyx3655e")
